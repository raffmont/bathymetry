...
- BATHY_VECTOR_MBTILES    (default: ./data/output/bathy_contours.mbtiles)
- BATHY_RASTER_MBTILES    (default: ./data/output/bathy_raster.mbtiles)
- BATHY_HILLSHADE_MBTILES (default: ./data/output/bathy_hillshade.mbtiles)
- BATHY_SLOPE_MBTILES     (default: ./data/output/bathy_slope.mbtiles)
- TILEJSON_DIR            (default: ./data/output/tilejson)
...
VECTOR_MBTILES = _mbtiles_path("BATHY_VECTOR_MBTILES", "./data/output/bathy_contours.mbtiles")
BATHY_MBTILES  = _mbtiles_path("BATHY_RASTER_MBTILES", "./data/output/bathy_raster.mbtiles")
HS_MBTILES     = _mbtiles_path("BATHY_HILLSHADE_MBTILES", "./data/output/bathy_hillshade.mbtiles")
SLOPE_MBTILES  = _mbtiles_path("BATHY_SLOPE_MBTILES", "./data/output/bathy_slope.mbtiles")
TILEJSON_DIR   = Path(os.environ.get("TILEJSON_DIR", "./data/output/tilejson")).expanduser().resolve()
